...
#define ENABLE_CONTROL3() HAL_GPIO_WritePin(ENABLE_3_GPIO_Port, ENABLE_3_Pin, GPIO_PIN_RESET)  // ENABLE_2_Pin引脚置低电平使能电机
#define DISENABLE_CONTROL3() HAL_GPIO_WritePin(ENABLE_3_GPIO_Port, ENABLE_3_Pin, GPIO_PIN_SET) // ENABLE_2_Pin引脚置高电平不使能电机
